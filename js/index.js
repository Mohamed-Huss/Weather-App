  ...
  for (let [index, day] of days.entries()) {
    ...
    cardsHTML += `
      ...
      <div class="card-header">
        ...
        <div class="time">${localTime.split(":")[0]}:${localTime.split(":")[1]} ${localTime.split(":")[0] > 11 ? "pm" : "am"}</div>
      </div>
      <div class="card-body">
        <img src="./images/conditions/${day.day.condition.text}.svg"/>
        <div class="degree">${day.hour[localTime.split(":")[0]].temp_c}°C</div>
      </div>
      <div class="card-data">
        <ul class="left-column">
          <li>Real Feel: <span class="real-feel">${day.hour[localTime.split(":")[0]].feelslike_c}°C</span></li>
          <li>Wind: <span class="wind">${day.hour[localTime.split(":")[0]].wind_kph} K/h</span></li>
          <li>Pressure: <span class="pressure">${day.hour[localTime.split(":")[0]].pressure_mb}Mb</span></li>
          <li>Humidity: <span class="humidity">${day.hour[localTime.split(":")[0]].humidity}%</span></li>
        </ul>
